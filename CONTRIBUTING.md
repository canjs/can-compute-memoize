# Contributing to can-compute-memoize

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-compute-memoize) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-compute-memoize, you can start by going to its [fork page](https://github.com/canjs/can-compute-memoize/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-compute-memoize
```
